...
const Page = () => {
  ...
  const currentlyBuildingRefs = useRef<{
    [key: string]: ScrambleInHandle | null;
  }>({});
  ...
  const triggerAnimations = () => {
    ...
    const startAllRefs = () => {
      ...
      Object.values(currentlyBuildingRefs.current).forEach((ref) =>
        ref?.start()
      );
    ...
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16 font-normal tracking-tight">
      <section className="mx-auto w-full max-w-3xl space-y-8 print:space-y-6">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold">
                      <ScrambleIn
                        ref={(el) =>
                          (socialRefs.current[`social-name-${index}`] = el)
                        }
                        text={social.name}
                        scrambleSpeed={25}
                        scrambledLetterCount={3}
                    ...
                    <p className="text-sm">
                      <ScrambleIn
                        ref={(el) =>
                          (socialRefs.current[`social-desc-${index}`] = el)
                        }
              ...
              <Card key={currentlyBuilding.name}>
                  ...
                  <div className="flex items-center gap-x-3">
                    ...
                    <div className="flex-grow">
                      <div className="flex items-center justify-between gap-x-2 text-base">
                        <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                          ...
                          >
                            <ScrambleIn
                              ref={(el) =>
                                (currentlyBuildingRefs.current[`name-${idx}`] =
                                  el)
                              }
                        ...
                        <div className="text-sm tabular-nums text-gray-500">
                          <ScrambleIn
                            ref={(el) =>
                              (currentlyBuildingRefs.current[`date-${idx}`] =
                                el)
                            }
                      ...
                      <h4 className="font-mono text-sm leading-none max-w-[500px]">
                        <ScrambleIn
                          ref={(el) =>
                            (currentlyBuildingRefs.current[`title-${idx}`] = el)
                          }
                ...
                <CardContent className="flex flex-col mt-2 gap-4">
                  <p className="text-xs">
                    <ScrambleIn
                      ref={(el) =>
                        (currentlyBuildingRefs.current[`desc-${idx}`] = el)
                      }
                ...
                {/* <CardFooter>
                  <Button>
                    ...
                    >
                      <ScrambleIn
                        ref={(el) =>
                          (currentlyBuildingRefs.current[`view-${idx}`] = el)
                        }
                        text="View details"
                        scrambleSpeed={25}
                        scrambledLetterCount={3}
                  ...
                  <span className="inline-flex gap-x-1">
                    {award.badges.map((badge, badgeIdx) => (
                      ...
                      >
                        <ScrambleIn
                          ref={(el) =>
                            (awardRefs.current[`badge-${idx}-${badgeIdx}`] = el)
                          }
                          text={badge}
                          scrambleSpeed={20}
                          scrambledLetterCount={2}
                      ...
                      <div className="flex items-center justify-between gap-x-2 text-lg">
                        <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                          ...
                          >
                            <ScrambleIn
                              ref={(el) =>
                                (workRefs.current[`company-${idx}`] = el)
                              }
                              text={work.company}
                              scrambleSpeed={25}
                              scrambledLetterCount={3}
                  ...
                  <span className="inline-flex gap-x-1 mt-4">
                    {work.badges.map((badge, badgeIdx) => (
                      ...
                      >
                        <ScrambleIn
                          ref={(el) =>
                            (workRefs.current[`badge-${idx}-${badgeIdx}`] = el)
                          }
                          text={badge}
                          scrambleSpeed={20}
                          scrambledLetterCount={2}
            ...
            return (
              <Card key={education.school}>
                  ...
                  <div className="flex items-center gap-x-3">
                    ...
                    <div className="flex-grow">
                      <div className="flex items-center justify-between gap-x-2 text-base">
                        <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                          <p>
                            <ScrambleIn
                              ref={(el) =>
                                (educationRefs.current[`school-${idx}`] = el)
                              }
                        ...
                        <div className="text-sm tabular-nums text-gray-500">
                          <ScrambleIn
                            ref={(el) =>
                              (educationRefs.current[`date-${idx}`] = el)
                            }
                      ...
                      <h4 className="font-mono text-sm leading-none max-w-[500px]">
                        <ScrambleIn
                          ref={(el) =>
                            (educationRefs.current[`degree-${idx}`] = el)
                          }
                ...
                <CardContent className="mt-2 text-xs">
                  <ScrambleIn
                    ref={(el) =>
                      (educationRefs.current[`activities-${idx}`] = el)
                    }
        ...
        {/* <Section id="music">
          ...
          {RESUME_DATA.Freelance.map((award) => {
            return (
              <Card key={award.awardName} className="text-sm">
                ...
                <CardContent>{award.description}</CardContent>
              </Card>
            );
          })}
        </Section> */}
      ...
      <CommandMenu
        links={[
          ...RESUME_DATA.contact.social.map((socialMediaLink) => ({
            url: "url" in socialMediaLink ? socialMediaLink.url : "#",
