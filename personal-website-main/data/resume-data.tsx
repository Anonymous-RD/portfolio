...
export const RESUME_DATA = {
  ...
  personalWebsiteUrl: "https://zenrohit.me",
  contact: {
    email: "work.rohit.me@gmail.com",
    social: [
      {
        name: "LinkedIn",
      ...
      {
        name: "X.com / Twitter",
        url: "https://x.com/Rohithaldar22",
        icon: XIcon,
        // description: "Documenting my journey on building apps and business",
        description: "building apps and business",
      },
      {
        name: "Instagram",
